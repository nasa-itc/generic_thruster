...
def run_generic_thruster_ast_test():
    ##
    ...
    #
    #    wait_check(f"GENERIC_THRUSTER_DEBUG GENERIC_THRUSTER_HK_TLM DEVICE_COUNT >= {dev_cmd_cnt}", 5)
    #    wait_check(f"GENERIC_THRUSTER_DEBUG GENERIC_THRUSTER_HK_TLM DEVICE_ERR_COUNT >= {dev_cmd_err_cnt}", 5)
    #
