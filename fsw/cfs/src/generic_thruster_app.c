  ...
  while (CFE_ES_RunLoop(&GENERIC_THRUSTER_AppData.RunStatus) == true) {
    ...
    */
    status = CFE_SB_ReceiveBuffer(
        (CFE_SB_Buffer_t **)&GENERIC_THRUSTER_AppData.MsgPtr,
    ...
    */
    if (status == CFE_SUCCESS) {
      ...
      CFE_EVS_SendEvent(GENERIC_THRUSTER_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
                        "GENERIC_THRUSTER: SB Pipe Read Error = %d",
                        (int)status);
      GENERIC_THRUSTER_AppData.RunStatus = CFE_ES_RunStatus_APP_ERROR;
    }
  }
...
int32 GENERIC_THRUSTER_AppInit(void) {
  ...
  */
  ...
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_THRUSTER: Error registering for event services: 0x%08X\n",
        (unsigned int)status);
    return status;
  }
  ...
  */
  status = CFE_SB_CreatePipe(&GENERIC_THRUSTER_AppData.CmdPipe,
                             GENERIC_THRUSTER_PIPE_DEPTH, "GEN_THR");
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_THRUSTER_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_THRUSTER_CMD_MID),
                            GENERIC_THRUSTER_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_THRUSTER_REQ_HK_MID),
                            GENERIC_THRUSTER_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_THRUSTER_SUB_REQ_HK_ERR_EID,
  ...
  ** telemetry that has been defined in the GENERIC_THRUSTER_HkTelemetryPkt for
  *this app.
  */
  ...
  *block
  */
  GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceEnabled =
      GENERIC_THRUSTER_DEVICE_DISABLED;
  ...
  status = CFE_EVS_SendEvent(
      GENERIC_THRUSTER_STARTUP_INF_EID, CFE_EVS_EventType_INFORMATION,
      "GENERIC_THRUSTER App Initialized. Version %d.%d.%d.%d",
      GENERIC_THRUSTER_MAJOR_VERSION, GENERIC_THRUSTER_MINOR_VERSION,
      GENERIC_THRUSTER_REVISION, GENERIC_THRUSTER_MISSION_REV);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_THRUSTER: Error sending initialization event: 0x%08X\n",
        (unsigned int)status);
  }
  return status;
}
...
void GENERIC_THRUSTER_ProcessCommandPacket(void) {
  ...
  /*
  ** Ground Commands with command codes fall under the GENERIC_THRUSTER_CMD_MID
  *(Message ID)
  */
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_THRUSTER_PROCESS_CMD_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "GENERIC_THRUSTER: Invalid command packet, MID = 0x%x",
...
void GENERIC_THRUSTER_ProcessGroundCommand(CFE_MSG_Message_t *Msg) {
  ...
  */
  case GENERIC_THRUSTER_NOOP_CC:
    ...
    */
    if (GENERIC_THRUSTER_VerifyCmdLength(
            GENERIC_THRUSTER_AppData.MsgPtr,
            sizeof(GENERIC_THRUSTER_NoArgs_cmd_t)) == OS_SUCCESS) {
      /* Second, send EVS event on successful receipt ground commands*/
      CFE_EVS_SendEvent(GENERIC_THRUSTER_CMD_NOOP_INF_EID,
  ...
  */
  case GENERIC_THRUSTER_RESET_COUNTERS_CC:
    if (GENERIC_THRUSTER_VerifyCmdLength(
            GENERIC_THRUSTER_AppData.MsgPtr,
            sizeof(GENERIC_THRUSTER_NoArgs_cmd_t)) == OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_THRUSTER_CMD_RESET_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_THRUSTER_ENABLE_CC:
    if (GENERIC_THRUSTER_VerifyCmdLength(
            GENERIC_THRUSTER_AppData.MsgPtr,
            sizeof(GENERIC_THRUSTER_NoArgs_cmd_t)) == OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_THRUSTER_CMD_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_THRUSTER_DISABLE_CC:
    if (GENERIC_THRUSTER_VerifyCmdLength(
            GENERIC_THRUSTER_AppData.MsgPtr,
            sizeof(GENERIC_THRUSTER_NoArgs_cmd_t)) == OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_THRUSTER_CMD_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_THRUSTER_PERCENTAGE_CC:
    if (GENERIC_THRUSTER_VerifyCmdLength(
      ...
      CFE_EVS_SendEvent(GENERIC_THRUSTER_CMD_PERCENTAGE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_THRUSTER_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "GENERIC_THRUSTER: Invalid command code for packet, MID "
                      "= 0x%x, cmdCode = 0x%x",
...
void GENERIC_THRUSTER_ProcessTelemetryRequest(void) {
  ...
  */
  default:
    /* Increment the error counter upon receipt of an invalid command */
    GENERIC_THRUSTER_AppData.HkTelemetryPkt.CommandErrorCount++;
    CFE_EVS_SendEvent(GENERIC_THRUSTER_DEVICE_TLM_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "GENERIC_THRUSTER: Invalid command code for packet, MID "
                      "= 0x%x, cmdCode = 0x%x",
                      CFE_SB_MsgIdToValue(MsgId), CommandCode);
...
void GENERIC_THRUSTER_ReportHousekeeping(void) {
  ...
  CFE_SB_TimeStampMsg(
      (CFE_MSG_Message_t *)&GENERIC_THRUSTER_AppData.HkTelemetryPkt);
  CFE_SB_TransmitMsg(
      (CFE_MSG_Message_t *)&GENERIC_THRUSTER_AppData.HkTelemetryPkt, true);
  return;
}
...
void GENERIC_THRUSTER_Enable(void) {
  ...
  if (GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_THRUSTER_DEVICE_DISABLED) {
    /*
    ...
    *available
    */
    GENERIC_THRUSTER_AppData.Generic_thrusterUart.deviceString =
        GENERIC_THRUSTER_CFG_STRING;
    GENERIC_THRUSTER_AppData.Generic_thrusterUart.handle =
        GENERIC_THRUSTER_CFG_HANDLE;
    GENERIC_THRUSTER_AppData.Generic_thrusterUart.isOpen = PORT_CLOSED;
    GENERIC_THRUSTER_AppData.Generic_thrusterUart.baud =
        GENERIC_THRUSTER_CFG_BAUDRATE_HZ;
    GENERIC_THRUSTER_AppData.Generic_thrusterUart.access_option =
        uart_access_flag_RDWR;
    ...
    if (status == OS_SUCCESS) {
      ...
      GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceEnabled =
          GENERIC_THRUSTER_DEVICE_ENABLED;
      CFE_EVS_SendEvent(GENERIC_THRUSTER_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "GENERIC_THRUSTER: Device enabled");
    } else {
      GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(
          GENERIC_THRUSTER_UART_INIT_ERR_EID, CFE_EVS_EventType_ERROR,
          "GENERIC_THRUSTER: UART port initialization error %d", status);
    }
  } else {
    GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceErrorCount++;
    CFE_EVS_SendEvent(
        GENERIC_THRUSTER_ENABLE_ERR_EID, CFE_EVS_EventType_ERROR,
...
void GENERIC_THRUSTER_Disable(void) {
  ...
  if (GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceEnabled ==
    ...
    if (status == OS_SUCCESS) {
      ...
      GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceEnabled =
          GENERIC_THRUSTER_DEVICE_DISABLED;
      CFE_EVS_SendEvent(GENERIC_THRUSTER_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "GENERIC_THRUSTER: Device disabled");
    } else {
      GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(GENERIC_THRUSTER_UART_CLOSE_ERR_EID,
                        CFE_EVS_EventType_ERROR,
    ...
    GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceErrorCount++;
    CFE_EVS_SendEvent(
        GENERIC_THRUSTER_DISABLE_ERR_EID, CFE_EVS_EventType_ERROR,
...
void GENERIC_THRUSTER_Percentage(GENERIC_THRUSTER_Percentage_cmd_t *Msg) {
  if (GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_THRUSTER_DEVICE_ENABLED) {
    int32_t status;
    CFE_EVS_SendEvent(GENERIC_THRUSTER_PERCENTAGE_INF_EID,
                      CFE_EVS_EventType_INFORMATION,
                      "GENERIC_THRUSTER: Thruster %d, percentage on %d",
                      Msg->ThrusterNumber, Msg->Percentage);
    status = GENERIC_THRUSTER_SetPercentage(
        &GENERIC_THRUSTER_AppData.Generic_thrusterUart, Msg->ThrusterNumber,
        Msg->Percentage, 6);
    if (status < 0) {
      GENERIC_THRUSTER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(GENERIC_THRUSTER_CMD_PERCENTAGE_EID,
                        CFE_EVS_EventType_ERROR,
      ...
      int32 DataLen;
      DataLen =
      uart_bytes_available(&GENERIC_THRUSTER_AppData.Generic_thrusterUart); //
      check how many bytes are waiting on the uart if (DataLen > 0)
      {
          uart_read_port(&GENERIC_THRUSTER_AppData.Generic_thrusterUart,
      DataBuffer, DataLen); OS_printf("GENERIC_THRUSTER: Response on UART=");
          for (int i = 0; i < DataLen; i++) OS_printf("0x%2.2x ",
      DataBuffer[i]); OS_printf("\n");
      }*/
    }
  } else {
    CFE_EVS_SendEvent(
        GENERIC_THRUSTER_PERCENTAGE_ERR_EID, CFE_EVS_EventType_ERROR,
...
*/
int32 GENERIC_THRUSTER_VerifyCmdLength(CFE_MSG_Message_t *msg,
  ...
  if (expected_length == actual_length) {
    ...
    CFE_EVS_SendEvent(
        GENERIC_THRUSTER_LEN_ERR_EID, CFE_EVS_EventType_ERROR,
