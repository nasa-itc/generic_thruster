...
** This struct is defined in the `generic_thruster_app.h` file with one global
*instance
** in the `.c` file.
*/
typedef struct {
  ...
  */
  GENERIC_THRUSTER_Hk_tlm_t
      HkTelemetryPkt; /* GENERIC_THRUSTER Housekeeping Telemetry Packet */
...
*/
extern GENERIC_THRUSTER_AppData_t
    GENERIC_THRUSTER_AppData; /* GENERIC_THRUSTER App Data */
