 ...
 *
 * Purpose:
 * Extra scaffolding functions for the generic_thruster_app unit test
 *
 * Notes:
...
#ifndef UT_GENERIC_THRUSTER_APP_H
#define UT_GENERIC_THRUSTER_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "GENERIC_THRUSTER_APP_Data_t" typedef.
 */
#include "generic_thruster_app.h"

/*
 * Allow UT access to the global "GENERIC_THRUSTER_APP_Data" object.
 */
// extern GENERIC_THRUSTER_AppData_t GENERIC_THRUSTER_APP_Data;

#endif /* UT_GENERIC_THRUSTER_APP_H */
