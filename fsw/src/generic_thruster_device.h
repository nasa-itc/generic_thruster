...
#define GENERIC_THRUSTER_DEVICE_NOOP_CMD         0x00
#define GENERIC_THRUSTER_DEVICE_REQ_HK_CMD       0x01
#define GENERIC_THRUSTER_DEVICE_REQ_DATA_CMD     0x02
#define GENERIC_THRUSTER_DEVICE_CFG_CMD          0x03
...
#define GENERIC_THRUSTER_DEVICE_CMD_SIZE         9
...
/*
** GENERIC_THRUSTER device data telemetry definition
*/
typedef struct
{
    uint32_t  DeviceCounter;
...
} __attribute__((packed)) GENERIC_THRUSTER_Device_Data_tlm_t;
#define GENERIC_THRUSTER_DEVICE_DATA_LNGTH sizeof ( GENERIC_THRUSTER_Device_Data_tlm_t )
#define GENERIC_THRUSTER_DEVICE_DATA_SIZE GENERIC_THRUSTER_DEVICE_DATA_LNGTH + GENERIC_THRUSTER_DEVICE_HDR_TRL_LEN
...
int32_t GENERIC_THRUSTER_CommandDevice(uart_info_t* device, uint8_t cmd, uint32_t payload);
